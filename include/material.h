...
class lambertian : public material {
  public:
    ...
    const override {
        ...
        srec.skip_pdf_ray = ray(rec.p, scattered_direction, r_in.time()); // For backward compatibility
...
class isotropic : public material {
  public:
    ...
    bool scatter(const ray& r_in, const hit_record& rec, scatter_record& srec) const override {
        srec.skip_pdf_ray = ray(rec.p, random_unit_vector(), r_in.time()); // For backward compatibility
